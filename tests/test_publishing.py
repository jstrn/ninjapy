        ...
        for script_path in scripts:
            ...
            if path.exists():
                ...
                if os.name != 'nt':  # Not Windows
                    assert os.access(path, os.X_OK), f"Script {script_path} is not executable"
...
class TestVersionBumping:
    ...
    def test_version_parsing(self):
        ...
        try:
            ...
            from version_bump import parse_version, format_version, bump_version
    ...
    def test_workflow_has_required_jobs(self):
        ...
        if publish_workflow.exists():
            ...
            for job in expected_jobs:
                assert job in workflow['jobs'], f"Job '{job}' not found in publish workflow"
