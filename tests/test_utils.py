...
class TestTimestampConversion:
    ...
    def test_convert_epoch_to_iso_float(self):
        ...
        assert result == "2024-10-09T14:52:21.725760Z"
    ...
    def test_convert_timestamps_in_dict(self):
        ...
        assert result["created"] == "2024-10-09T14:52:21.725760Z"
    ...
    def test_convert_timestamps_in_list(self):
        ...
        assert len(result) == 2
        assert result[0]["created"] == "2024-10-09T14:52:21.725760Z"
    ...
    def test_convert_timestamps_nested(self):
        ...
        assert result["device"]["created"] == "2024-10-09T14:52:21.725760Z"
        assert result["device"]["details"]["lastUpdate"] == "2022-01-01T00:00:00Z"
        assert result["activities"][0]["timestamp"] == "2024-10-09T14:52:21.725760Z"
    ...
    def test_convert_timestamps_custom_fields(self):
        ...
        assert result["customTime"] == "2024-10-09T14:52:21.725760Z"
    ...
    def test_process_api_response_additional_fields(self):
        ...
        response_data = {
            "customTimeField": 1728487941.725760,
            "regularField": "value"
        }
        ...
        assert result["customTimeField"] == "2024-10-09T14:52:21.725760Z"
        assert result["regularField"] == "value" 